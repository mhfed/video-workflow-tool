...
export function whiteboardHandSignature({project}={}) { return penAppearanceSignature(project); }
...
export async function renderWhiteboardScene({ scene, project, imageFile, outputFile, durationSec, cfg,signal }) {
