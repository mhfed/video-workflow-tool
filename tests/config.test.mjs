...
test('accepts a ChatGPT subscription text provider without an OpenAI API key',()=>{
  const result=validateConfig({...base,textProvider:'codex',imageProvider:'mock',voiceProvider:'mock',openaiApiKey:'',codexTimeoutMs:300000});
  assert.equal(result.ok,true);
});
